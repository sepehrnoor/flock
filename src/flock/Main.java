    ...
    public static void main(String[] args) {
        ...
        try{
            while (true) {
                String s = bufferedReader.readLine();
                 if (s.toLowerCase().contains("help") || s.toLowerCase().contains("?")){
                    ...
                    if (sp.length < 2) {
                        ...
                        } else if (command.toLowerCase().equals("avoidForce")){
                ...
                } else if (s.toLowerCase().contains("avoidForce")){
                    String[] sp = s.split(" ");
                    try{
                        ...
                        System.out.println("Please enter a valid argument (e.g. avoidForce 2.0)");
                    }
